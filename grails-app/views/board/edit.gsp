...
<body>
<a href="#edit-board" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="edit-board" class="content scaffold-edit" role="main">
    ...
    <g:form url="[resource: boardInstance, action: 'update']" name="gameForm">
